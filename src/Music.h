/**\file Music.h
 * \brief Módulo com a estrutura de uma música
 *
 * PROJECTO: Projecto - Arkanoid \n
 * FICHEIRO: Music.h \n
 * DESCRIÇÃO: Módulo com a estrutura de uma música \n
 *
 * TURMA : COMP_155 \n
 * AUTORES:
...
///Liberta o espaco alocado para a musica *music

void delMusic(Music *music);

///Adicion uma nota a uma dada musica
Music* addNote(Music *music, Note *note);

void play_music(Music *music);

///Percorre um array tocando cada nota
